...
def calcular_cuartiles(poblacion):
    ...
    cuartil_1 = poblacion_ordenada[n // 4]
    cuartil_2 = poblacion_ordenada[n // 2]
    cuartil_3 = poblacion_ordenada[(3 * n) // 4]
...
def calcular_quintiles(poblacion):
    poblacion_ordenada = sorted(poblacion)
    n = len(poblacion_ordenada)
    quintil_1 = poblacion_ordenada[n // 5]
    quintil_2 = poblacion_ordenada[2 * (n // 5)]
    quintil_3 = poblacion_ordenada[3 * (n // 5)]
    quintil_4 = poblacion_ordenada[4 * (n // 5)]
